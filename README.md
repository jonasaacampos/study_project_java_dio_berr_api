...
<h1>Desenvolvimento de testes unitários para validar uma API REST de gerenciamento estoques de cerveja</h1>

<img alt="DIO logo" src="https://hermes.digitalinnovation.one/assets/diome/logo.svg" width=150 align=right>

Teste unitário de uma API REST para o gerenciamento de estoques de cerveja, entregue como requisito para conclusão do bootcamp **Fullstack Developer** da [DIO](https://dio.me/sign-up?ref=B4LLE4R5RE).
